...
python d4tl_mujoco_td3.py --env=hopper-medium-v2 --learn_id=modelfree/d4rl/hop-m-v2/td3/seed10 --seed=10
python d4tl_mujoco_td3.py --env=hopper-medium-v2 --learn_id=modelfree/d4rl/hop-m-v2/td3/seed20 --seed=20
python d4tl_mujoco_td3.py --env=hopper-medium-v2 --learn_id=modelfree/d4rl/hop-m-v2/td3/seed30 --seed=30
echo "--------Run TD3 in halfcheetah-medium-v2---------"
python d4tl_mujoco_td3.py --env=halfcheetah-medium-v2 --learn_id=modelfree/d4rl/half-m-v2/td3/seed10 --seed=10
python d4tl_mujoco_td3.py --env=halfcheetah-medium-v2 --learn_id=modelfree/d4rl/half-m-v2/td3/seed20 --seed=20
python d4tl_mujoco_td3.py --env=halfcheetah-medium-v2 --learn_id=modelfree/d4rl/half-m-v2/td3/seed30 --seed=30
echo "--------Run TD3 in walker2d-medium-v2---------"
python d4tl_mujoco_td3.py --env=walker2d-medium-v2 --learn_id=modelfree/d4rl/walk-m-v2/td3/seed10 --seed=10
python d4tl_mujoco_td3.py --env=walker2d-medium-v2 --learn_id=modelfree/d4rl/walk-m-v2/td3/seed20 --seed=20
python d4tl_mujoco_td3.py --env=walker2d-medium-v2 --learn_id=modelfree/d4rl/walk-m-v2/td3/seed30 --seed=30