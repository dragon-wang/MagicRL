...
python mujoco_td3bc.py --env=hopper-random-v2 --learn_id=td3bc/Hopper-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=hopper-medium-v2 --learn_id=td3bc/Hopper-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=hopper-expert-v2 --learn_id=td3bc/Hopper-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=hopper-medium-expert-v2 --learn_id=td3bc/Hopper-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=hopper-medium-replay-v2 --learn_id=td3bc/Hopper-v2/medium/seed10 --seed=10 --device=cuda
echo "--------Run TD3BC in halfcheetah---------"
python mujoco_td3bc.py --env=halfcheetah-random-v2 --learn_id=td3bc/HalfCheetah-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=halfcheetah-medium-v2 --learn_id=td3bc/HalfCheetah-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=halfcheetah-expert-v2 --learn_id=td3bc/HalfCheetah-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=halfcheetah-medium-expert-v2 --learn_id=td3bc/HalfCheetah-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=halfcheetah-medium-replay-v2 --learn_id=td3bc/HalfCheetah-v2/medium/seed10 --seed=10 --device=cuda
echo "--------Run TD3BC in walker2d---------"
python mujoco_td3bc.py --env=walker2d-random-v2 --learn_id=td3bc/Walker2d-v2/medium/seed10 --seed=10 --device=cuda
python mujoco_td3bc.py --env=walker2d-medium-v2 --learn_id=td3bc/Walker2d-v2/medium/seed10 --seed=10 --device=cuda
